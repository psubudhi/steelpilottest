...
st.markdown(
    """
    <style>
    .main-title {font-size: 2.0rem; font-weight: 850; margin-bottom: 0.1rem;}
    .subtitle {color: #64748b; margin-bottom: 1rem;}
    .small-muted {color: #64748b; font-size: 0.88rem;}
    .card {border: 1px solid #e5e7eb; border-radius: 16px; padding: 14px; background: #ffffff; box-shadow: 0 1px 6px rgba(0,0,0,0.05); margin-bottom: 10px;}
    .stand-card {border: 1px solid #e5e7eb; border-radius: 16px; padding: 14px; background: #ffffff; box-shadow: 0 1px 6px rgba(0,0,0,0.06); min-height: 225px;}
    .stand-title {font-weight: 800; font-size: 1.02rem; margin-bottom: 0.3rem;}
    .risk-low {border-left: 8px solid #22c55e;}
    .risk-medium {border-left: 8px solid #f59e0b;}
    .risk-high {border-left: 8px solid #ef4444;}
    .risk-critical {border-left: 8px solid #7f1d1d;}
    .alarm-box {border: 1px solid #fecaca; background: #fff7f7; padding: 12px; border-radius: 12px;}
    .ok-box {border: 1px solid #bbf7d0; background: #f0fdf4; padding: 12px; border-radius: 12px;}
    .evidence-step {border-left: 4px solid #6366f1; padding: 10px 14px; margin-bottom: 10px; background: #f8fafc; border-radius: 10px;}
    .rule-triggered {border-left: 6px solid #ef4444;}
    .rule-muted {border-left: 6px solid #cbd5e1; opacity: 0.88;}
    </style>
    """,
